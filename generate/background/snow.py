...
COLOR_MIN = (220, 220, 220, 255)
COLOR_MAX = (240, 240, 240, 255)
...
#    green = random.randrange(colorA[1], colorB[1]+1)
    green = red
    blue = random.randrange(red, colorB[2]+1)
    alpha = random.randrange(colorA[3], colorB[3]+1)
    return (red, green, blue, alpha)

def getRandomSandColor():
    return getRandomColorFromRange(COLOR_MIN, COLOR_MAX)
...
class Piece:
  def __init__(self, centerX=0, centerY=0, outerWidth=0, outerHeight=0):
    ...
    # self.lightColor = (lightShade, lightShade, lightShade, 255)
    self.darkColor = getRandomSandColor()
  ...
  def draw(self, drawer):
    ...
    drawer.ellipse(outerCorners, fill=self.darkColor)
    # drawer.ellipse(innerCorners, fill=self.lightColor)
  ...
  def getShifted(self, x, y):
    ...
    # pieceShifted.lightColor = self.lightColor
    pieceShifted.darkColor = self.darkColor
    return pieceShifted
